...
EXERCISE: Use non-parametric bootstrapping to derive a 95% confidence interval for the CV of $x$. Start by writing a function that computes the CV for a variable (see the Appendix for a brief introduction to writing functions in `R`.
