...
Eigenanalysis is closely related to principal component analysis. In its simplest form, the principal components are the same as the eigenvectors. Let us derive some new traits along the eigenvectors of $\textbf{C}$.
