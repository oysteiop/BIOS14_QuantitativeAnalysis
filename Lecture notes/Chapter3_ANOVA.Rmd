...
The `Sum Sq` are the sums of squares, i.e. the sum of the squared deviations of each observation from the grand mean. The total sum of squares ($SS_T$) divided by $n-1$ gives the total variance of the sample. Call the `var` function to confirm that this is the case.
...
```{r, fig.height=4, fig.width=4, echo=F, fig.cap="Larval developmental time depending on larval and maternal host plant. Error bars indicate standard errors" }
